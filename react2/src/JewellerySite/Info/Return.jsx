...
const Return = () => {
  return (
    ...
    <div className='ship'>
       ...
       <p>We have 7 days no questions asked return and exchange policy.</p>
       <p>The exchange value will be calculated as follows:</p>
    <ul>
        <li>Gold: 100% of the invoice value</li>
        <li>Diamond: 100% of the invoice value</li>
        <li>Making charges: none</li>
        <li>GST: none</li>
    </ul>
    <p>In case you wish to raise a request for a return and exchange, you are requested to write an email to <a href="mailto:hi@mimulux.in">hi@truediamond.in</a> with your order number, invoice, photograph of the product, and the authentication certificate.</p>
